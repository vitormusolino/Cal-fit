...
function Precisao() {
    return ( <>
            <div className='flex bg-cinza-escuro-bg py-12 mx-52 px-10 rounded-lg mt-20 justify-around mb-20'>
                    <div className='flex flex-col justify-center'>
                        <h1 className='text-4xl font-bold mb-10'>O quão preciso é o Fit Cal?</h1>
